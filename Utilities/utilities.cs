    ...
    public class utilities
    {
        ...
        public static SqlConnection connectToSQL()
        {
            try
            {
                ...
                String dataValues = "Data Source=192.168.1.18;Initial Catalog=ERP10DB;Integrated Security=True;User ID=sa;Password=Epicor123;";
        ...
        public static void closeSQL(SqlConnection connection)
        {
            ...
            {
                MessageBox.Show("Error SQL:" + ex, "Utilities SQLException", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        public int nextId(string field, string table, SqlConnection conn = null, string connectionValues = null)
        {
            ...
            {
                MessageBox.Show("Exception found: " + e.Message,"Utilities SQLEception",MessageBoxButtons.OK,MessageBoxIcon.Warning);
            }
            return id;
        }
